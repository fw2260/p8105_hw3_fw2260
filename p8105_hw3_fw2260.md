...
so that observation was removed.
...
The most commonly observed value for snowfall is 0 mm which makes sense
because in NY, there are many days where it does not snow.
...
```
    ...
    ## Warning: Removed 5256 row(s) containing missing values (geom_path).
...
temperature. The median snowfall every year is 25 mm, with Q1 around 13
mm and Q3 around 50 mm. There are a few years, like 1998, 2006, and
2010, that had less snowfall.
