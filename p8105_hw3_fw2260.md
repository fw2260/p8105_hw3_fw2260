...
Date was separated into year, month, and day. Temperature and
precipitation were changed from tenths of a unit to a whole unit.
...
And `NA` makes sense because many stations did not collect snowfall
data.
