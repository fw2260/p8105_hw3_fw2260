...
The most commonly observed values for snowfall are 0 mm and `NA`. 0 makes sense because in NY, there are many days where it does not snow. `NA` makes sense because there is a lot of missing data.
...
In general, as minimum temperature increases, so does maximum temperatue. The median snowfall every year is 25 mm, with Q1 around 13 mm and Q3 around 50 mm. There are a few years, like 1998 and 2006, that had less snowfall.