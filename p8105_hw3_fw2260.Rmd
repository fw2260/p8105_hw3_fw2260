...
Date was separated into year, month, and day. Month was changed from numbers to names. Temperature and precipitation were changed from tenths of a unit to a whole unit. One station had recorded -13 mm of snowfall so that observation was removed.
...
The most commonly observed value for snowfall is 0 mm which makes sense because in NY, there are many days where it does not snow.
