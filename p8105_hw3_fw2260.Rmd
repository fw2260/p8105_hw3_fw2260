...
Date was separated into year, month, and day. Temperature and precipitation were changed from tenths of a unit to a whole unit.
...
The most commonly observed values for snowfall are 0 mm and `NA`. 0 makes sense because in NY, there are many days where it does not snow. And `NA` makes sense because many stations did not collect snowfall data.
...
Average maximum temperature is higher in July than January overall, which makes sense as it is summer in NY. 
...
In general, as minimum temperature increases, so does maximum temperature. The median snowfall every year is 25 mm, with Q1 around 13 mm and Q3 around 50 mm. There are a few years, like 1998, 2006, and 2010, that had less snowfall.